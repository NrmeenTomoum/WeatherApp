...
public struct ErrorResponse: Decodable {
    ...
    public enum ErrorCode: String, Decodable {
        ...
        case phoneNumberTooLong = "phone_number_too_long"
        case phoneNumberTooShort = "phone_number_too_short"
        case generic = "generic_error"
        case notFound = "not_found"
        case smartcarTokenExpired = "vendor_token_expired"
        case timeSlotNotAvailable = "timeslot_not_available_error"
        case paymentError = "payment_failed"
        case unknownType
    }
